  ...
  methods: {
    async updateSubjects() {
      try {
        ...
        const response = await axios.get("http://localhost:8000/latest_semester_codes");
        ...
        const apiUrl = `http://localhost:8000/timetable_data/${this.selectedCampus}/${latestSemesterCode}`;
